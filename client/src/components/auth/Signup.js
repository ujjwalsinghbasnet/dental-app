    ...
    <Box w="100%" maxW="1600px" margin="auto">
      ...
      >
        <Box w={{ base: "100%", sm: "100%", md: "100%", lg: "50%" }}>
          ...
          >
            Register in Dental World
          </Heading>
          <VStack mt="3rem" w="95%" align="start">
            ...
            <FormControl as="fieldset">
              ...
              <RadioGroup
                ...
                defaultValue="notConfirmed"
                {...getRootProps()}
                {...getRadioProps({ value: info.gender })}
              >
            ...
            <HStack height="4rem" align="center" spacing={4}>
              <Button variant="primary-btn" onClick={submitHandler}>
                Signup
              </Button>
              <Spacer />
              <Text>
