...
function Signup() {
  ...
  return (
    <Flex justify='space-between' w='100vw' maxW='1600px' h='100vh' px={{base: '2rem', sm: '3.5rem', md: '4rem', lg: '6rem'}} margin='auto' pt='8rem'>
      <Box w={{base: '100%', sm: '100%', md: '50%', lg:'55%'}} >
        <Heading as='h1' color='primary' fontSize={{ base: '2.8rem', sm: '3.8rem', md: '4.5rem', lg: '4rem'}} >Register in Dental World</Heading>
        <Heading as='h1' color='primary' fontSize={{ base: '2rem', sm: '3rem', md: '3.5rem', lg: '3rem'}}>digitalize traditional systems</Heading>
        <VStack
          mt='5rem'
          w='95%'
          align='start'
